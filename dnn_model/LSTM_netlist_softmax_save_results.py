...
class LSTM_classify(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_class, num_layer):
        super(LSTM_classify, self).__init__()
        self.n_layer = num_layer
        self.n_class = num_class
        self.lstm = nn.LSTM(input_dim, hidden_dim, self.n_layer, batch_first=True)
        self.classifier = nn.Linear(hidden_dim, self.n_class)  # may need change to sigmoid()
...
class DataReader:
    ...
    def __init__(self, base_path, source_config, config_type, num_workers, mode):
        ...
        self.read_data(base_path, source_config['DETECT_PARA'], config_type, num_workers, mode)
    ...
    def read_data(self, base_path, sub_config, config_type, num_workers, in_mode):
...
class Classifier_Netlist:
    def __init__(self,
        ...
        self.tra_data = DataReader(base_path=base_path, source_config=source_config, config_type='TRAIN_PARA',
                                   num_workers=num_tra_workers, mode='none')
        ...
        self.val_data = DataReader(base_path=base_path, source_config=source_config, config_type='TEST_PARA',
                                   num_workers=num_val_workers, mode='none')
        ...
        self.model = LSTM_classify(input_dim=self.emb_dimension,
